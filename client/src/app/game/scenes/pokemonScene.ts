...
export class pokemonScene extends Phaser.Scene {
	...
	selectedMenu: string;
	selectedMenu2: null;
	isSelectedMenu2: boolean;
	isBattleScene: boolean;
	isBagScene: boolean;
	switch_pokemon_index: null;
	party_empty_list: null[];
	party_fill_list: null[];
	party_highlight_list: null[];
	party_pokemon_list: null[];
	party_pokemon_hp: null[];
	selected_cancel: Phaser.GameObjects.Image;
	cancelText: Phaser.GameObjects.Text;
	bottom_left_box: Phaser.GameObjects.Graphics;
	bottom_right_box: Phaser.GameObjects.Graphics;
	bottom_left_text: Phaser.GameObjects.Text;
	shift_text: Phaser.GameObjects.Text;
