...
const call = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const provider = new ethers_1.ethers.providers.EtherscanProvider(ETHERSCAN_API_KEY);
        ...
        const nounsToken = new ethers_1.ethers.Contract('0xA7355007cCaee83105cd840c59dcB18c8d0EbB28', NounsTokenABI, signer);
