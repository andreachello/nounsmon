...
const alchemyProvider = new ethers_1.ethers.providers.JsonRpcProvider(API_URL);
// Signer
const signer = new ethers_1.ethers.Wallet(process.env.PRIVATE_KEY, alchemyProvider);
// SETUP NOUNS TOKEN CONTRACT
const nounsToken = new ethers_1.ethers.Contract('0x43F443aeCAF4F9A975a1a206c4C0902Df3f536A8', NounsTokenABI, signer);
const mintNoun = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // MINT NOUN (GOES TO CONTRACT OWNER)
        const mintTxResponse = yield nounsToken.mint();
        const mintTxReceipt = yield mintTxResponse.wait();
...
const catchNoun = (nounId, receiverAddress) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const nounsCaughtTxResponse = yield nounsToken.nounCaught(nounId, receiverAddress);
        const nounsCaughtTxReceipt = yield nounsCaughtTxResponse.wait();
...
const getNounSVG = (nounId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // // GET NOUN SVG DATA
        const tokenURI = yield nounsToken.tokenURI(nounId);
